<template>
    <div style="display: flex; flex-direction: row; justify-content: space-between;">
        <a-form layout="inline" :model="searchData">
            ...
            <a-form-item label="">
                <!-- <a-select style="width: 194px;" v-model:value="searchData.categoryId" placeholder="选择产品分类" allowClear>
    ...
    <input id="download" type="file" class="file" @change="(e) => handleUpload(e)" style="display: none" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel">
</template>
