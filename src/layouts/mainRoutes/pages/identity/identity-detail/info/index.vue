<template>
    <div class="identity-detail-info">
        <config-page title="返回" sub-title="返回到标识明细页">
            <a-row>
                <a-col :span="12">
                        ...
                        <a-tabs v-model:activeKey="activeKey">
                            <a-tab-pane key="1" tab="基本属性">
                                <div class="detail-info-form">
                                    <div class="info-form-item">
                                        <label>工业标识</label>
                                        <a-input style="width:300px" placeholder="工业标识" v-model:value="formState.idisCode"
                                            disabled></a-input>
                                    </div>
                                    <div class="info-form-item">
                            ...
                            <a-tab-pane key="2" tab="规格/属性">
                                <template v-if="formState.businessObjectAttrBOList">
                                    <div class="detail-info-form"
                                        v-for="(item, index) in formState.businessObjectAttrBOList" :key="index">
                                        <div class="info-form-item">
                                            <label>{{ item.attrNameCn }}</label>
                                            <a-input style="width:300px" placeholder="容量" v-model:value="item.attrValue"
                                                disabled></a-input>
                                        </div>
                                    </div>
                                </template>
