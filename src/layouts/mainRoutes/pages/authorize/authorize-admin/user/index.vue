<template>
    <div class="authorization-user" style="height: 100%">
        ...
        <a-modal width="660px" v-model:visible="visible" title="添加用户" @ok="handleSubmit()" @cancel="handleCancel">
        ...
        <a-modal v-model:visible="visibleRole" title="角色分配" @ok="handleSubmitRole()" @cancel="handleCancelRole">
            <a-tree autoExpandParent v-model:expandedKeys="expandedKeys" v-model:selectedKeys="selectedKeys" v-model:checkedKeys="checkedKeys" checkable checkStrictly :tree-data="roleSource" :field-names="fieldNames">
            </a-tree>
        </a-modal>
    </div>
</template>
